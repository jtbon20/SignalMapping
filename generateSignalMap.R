...
#@Description: Script that generates a local-area map overlaid with signal-strength data. The data comes from a map (YAML and PNG files) and a CSV of the signal strength at each tested point. This data is generated by a LiDAR equipped robot described at https://github.com/jtbon20/SignalMapping .
